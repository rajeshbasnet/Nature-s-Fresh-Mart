...
if (isset($_POST['traderSubmit'])) {
    ...
    if($count == 0) {
        ...
        $query = "INSERT INTO USERS(USER_ID, FIRST_NAME, LAST_NAME, ADDRESS, EMAIL, PHONE_NUMBER, PASSWORD, PROFILE_IMG, TOKEN, STATUS) VALUES (null, '$firstname', '$lastname', '$address', '$email', $phone_number, '$password', null , '$random_token', 0 )";
        ...
        if(mail($reciever, $body, $subject, $header)) {
            ...
            <script>
                setTimeout(() => {
                    location.href = "https://localhost/website/project/assets/form/signup/trader-signup/trader-signup.php";
                }, 5000)
            </script>
