            ...
            <form action="#" method="POST" class="trader-account">
                <fieldset>
                    ...
                    <div class="input-field w-75 mx-auto my-4">
                        ...
                        <p class="text-center mt-4"><a href="/website/project/homepage.php">Home</a> | Already have an account ? <a class="signin" href="https://localhost/website/project/assets/form/signin/signin.php">Click here...</a>
                        </p>
