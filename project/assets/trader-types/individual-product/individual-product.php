                            ...
                            while ($rowsLimit = oci_fetch_assoc($limitedRandomProducts)) {
                                ...
                                <li class="splide__slide">
                                    <div class="slider_product">
                                        <div class="img-container">
                                            <img src="../<?php echo $trader_type; ?>/images/products/<?php echo $rowsLimit['PRODUCT_IMAGE'] ?>"
                                                 class="w-100" alt=""/>
                                        </div>
                                        ...
                                        <div class="btn-container font-rubik">
                                            <a href="/website/project/assets/trader-types/individual-product/individual-product.php?search=<?php echo $rowsLimit['PRODUCT_ID'] ?>&type=greengrocer"
