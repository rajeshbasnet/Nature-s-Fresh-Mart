            ...
            <section class="w-75 mx-auto comments my-5">
                <div class="container-fluid">
                        ...
                        <div class="individual-comments font-rubik my-5">
                            <div class="customer-rating w-100 d-flex align-items-baseline justify-content-between">
                                ...
                                <div class="delete-container mr-4">
                                    <a href="/website/project/assets/trader-types/individual-product/reviews/delete-reviews.php?id=<?php echo $product_id; ?>&review=<?php echo $rowFifth['REVIEW_ID'] ?>&type=<?php echo $trader_type; ?>"><i class="fas fa-trash text-danger ml-0"></i></a>
                                </div>
                    ...
                    <div class="insert-reviews w-100 text-center">
                        <button class="btn btn-primary btn-review font-rubik">Click here to write your Reviews | Show/hide</button>
                        <?php
                            ...
                            <div class="row">
                                <div class="col-xl-8 m-0 p-0 mx-auto">
                                    ...
                                    <form action="#" method="POST" class="mt-4 p-0">
                                        ...
                                        <input type="hidden" class="trader_type" name="trader_type"  value="<?php echo $trader_type ?>">

                                        <label for="reviews" class="font-rubik p-0">Write your reviews here...</label>
                                        <textarea name="reviews" id="reviews" cols="100" rows="7" class="p-1 form-control"></textarea>
                                        <button type="submit" name="reviewSubmit" class="font-rubik btn btn-success mt-3">Submit Your Reviews</button>
                                    </form>
