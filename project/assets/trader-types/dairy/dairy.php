...
?>
    ...
    <header>
        ...
        <div class="bg-image position-absolute">
            <img src="images/bg-img/milk.jpg" class="w-100" alt=""/>
        </div>
        ...
        <div class="
          ...
          px-4
        ">
            <h2 class="text-center mb-4">Dairy</h2>
            <p class="text-center font-rubik">
                We produce our golden organic milk from their much-loved herd of Guernsey cows.
                They wander around the greenest grass in the Wiltshire valley and get to graze in wild flower meadows.
                They even get to groove to Classic FM in the milking parlour while Christine is milking them.
            </p>
        </div>
    </header>
    ...
    <main>
                    ...
                    <div class="breadcrumb-section">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-2 font-rubik">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="/website/project/assets/trader-types/dairy/dairy.php">Dairy</a>
                                </li>
        ...
        if (isset($_POST['searchSubmit'])) {
            ...
            $query = "SELECT * FROM TRADERS, SHOPS, PRODUCTS WHERE SHOPS.FK_TRADER_ID = TRADERS.TRADER_ID AND PRODUCTS.FK_SHOP_ID = SHOPS.SHOP_ID AND TRADERS.TRADER_TYPE = 'dairy' AND PRODUCTS.STATUS = 1 ";
            ...
            $result = fetch_all_products_of_trader("dairy", $connection);
        }
                        ...
                        <div class="individual-product in-<?php echo $count_animation;?> animate__animated animate__fadeInUp">
                            ...
                            <div class="info d-flex align-items-baseline justify-content-between mt-3">
                                ...
                                <p class="font-rubik price-content">
                                    £<?php echo number_format($discounted_result['total_price_after_discount'], '2', '.') ?></p>
                            </div>
                            <div class="btn-container font-rubik">
                                <a href="/website/project/assets/trader-types/individual-product/individual-product.php?search=<?php echo $row['PRODUCT_ID'] ?>&type=dairy"
