...
?>
    ...
    <main>
                    ...
                    <div class="breadcrumb-section">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-2 font-rubik">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="/website/project/assets/trader-types/fishmonger/fishmonger.php">Fishmonger</a>
                                </li>
                    ...
                    <div class="search-sort">
                        <form action="#" method="POST" class="d-flex align-items-center justify-content-end">
                            ...
                            <div class="btn-container mx-2 font-rubik">
                                <button type="submit" class="btn btn-md" name="searchSubmit">Search</button>
                            </div>
                        </form>
                    </div>
                </div>
        ...
        if (isset($_POST['searchSubmit'])) {
            ...
            $query = "SELECT * FROM TRADERS, SHOPS, PRODUCTS WHERE SHOPS.FK_TRADER_ID = TRADERS.TRADER_ID AND PRODUCTS.FK_SHOP_ID = SHOPS.SHOP_ID AND TRADERS.TRADER_TYPE = 'fishmonger' AND PRODUCTS.STATUS = 1 ";
            ...
            $result = fetch_all_products_of_trader("fishmonger", $connection);
        }
