...
?>
    ...
    <header>
        ...
        <div class="bg-image position-absolute">
            <img src="images/bg-img/pexels-becerra-govea-photo-5774154.jpg" class="w-100" alt="" />
        </div>
        ...
        <div class="
          ...
          px-4
        ">
            <h2 class="text-center mb-4">Butcher</h2>
            <p class="text-center font-rubik">
                For some of the best food you can plate up, our organic meat &
                sustainable fish is a cook's dream.
                From chicken to scallops, it's all top-notch, with sustainability
                playing a central role to how it's sourced and provide yourself with organic and fresh quanity goods.
            </p>
        </div>
    </header>
    ...
    <main>
                    ...
                    <div class="breadcrumb-section">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-2 font-rubik">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="/website/project/trader-types/butcher/butcher.php">Butcher</a>
                                </li>
        ...
        if (isset($_POST['searchSubmit'])) {
            ...
            $result = fetch_all_products_of_trader("butcher", $connection);
        }
                    ...
                    while ($row = oci_fetch_assoc($result)) { ?>
                        <div class="individual-product">
                            ...
                            <div class="btn-container font-rubik">
                                <a href="/website/project/assets/trader-types/individual-product/individual-product.php?search=<?php echo $row['PRODUCT_ID'] ?>&type=butcher"
