...
<header>
    ...
    <div class="bg-image position-absolute">
        <img src="images/bg-img/pexels-pixabay-219794.jpg" class="w-100" alt=""/>
    </div>
    ...
    <div class="
          ...
          px-4
        ">
        <h2 class="text-center mb-4">Greengrocer</h2>
        <p class="text-center font-rubik">
            After 30 glorious years of working with the greenest thumbs in organic farming
            we really know our carrots from our parsnips. The proof's in the tasting,
            so fill your boots with the best of the season's veggie delights right here and
            provide yourself with organic goods.
        </p>
    </div>
</header>
                ...
                <div class="breadcrumb-section">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-2 font-rubik">
                            ...
                            <li class="breadcrumb-item">
                                <a href="/website/project/assets/trader-types/greengrocer/greengrocer.php">Greengrocer</a>
                            </li>
        ...
        <div class="container-fluid w-100">
            <div class="products">
                ...
                while ($row = oci_fetch_assoc($result)) {
                    ...
                    <style>
                        .in-<?php echo $count_animations;?> {
                            animation-delay: <?php echo $delay; ?>s;
                        }
                    </style>


                    <div class="individual-product in-<?php echo $count_animations; ?> animate__animated animate__fadeInUp">
                        ...
                        <div class="info d-flex align-items-baseline justify-content-between mt-3">
                            <p class="font-rubik"><?php echo substr($row['PRODUCT_NAME'], 0, 25) ?>....<span
