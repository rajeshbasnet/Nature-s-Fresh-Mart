...
if (isset($_POST['insertProduct'])) {
    if (!empty($_POST['product-name']) && !empty($_POST['product-price']) && !empty($_POST['product-quantity']) && !empty($_POST['product-availability']) && !empty($_POST['product-desc'])) {
...
setTimeout(() => {
    window.location.href =
        "http://localhost/website/project/panels/trader-panel/crud-product/addproduct/addproduct.php";
}, 2000)
</script>
