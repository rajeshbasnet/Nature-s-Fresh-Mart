    ...
    if (isset($_POST['btnOffer'])) {
        if(!empty($_POST['offer_disc']) && !empty($_POST['offer_desc'])){
            ...
            if($up){
                ...
                echo "<button type='button' class='btn btn-outline-success btn-lg' style='white-space: normal;' disabled><i class='fas fa-check-circle' style='color:green;'></i>The offer has been updated</button>";
            }else{
