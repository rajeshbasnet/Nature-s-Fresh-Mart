                                ...
                                <div class="column-left w-100 mr-3">
                                    ...
                                    <?php
                                        while ($row=mysqli_fetch_assoc($result)){
                                            echo "<input type='hidden' name='user_id' value='<?php'. echo $row['user_id'].';?>'>";
                                        ...
                                        echo "<div class='column-right w-100 ml-3'>";
                                            echo "<div class='Username first_name mb-4'>";
                                                echo "<label for='first_name' class='form-label'>'.$row['first_name'].'</label>";
                                                echo "<input type='text' class='form-control' id='first_name' name='first_name'>";
                                            echo "</div>";

                                            echo "<div class='Username last_name mb-4'>";
                                                echo "<label for='last_name' class='form-label'>'.$row['last_name'].'</label>";
                                                echo "<input type='text' class='form-control' id='last_name' name='last_name'>";
                                            echo "</div>";


                                            echo "<div class='email my-4'>";
                                                echo "<label for='userEmail' class='form-label'>'.$row['email'].'</label>";
                                                echo "<input type='email' class='form-control' id='userEmail' name='userEmail'>";
                                            echo "</div>";


                                            echo "<div class='phone-number my-4'>";
                                                echo "<label for='phone-number' class='form-label'>'.$row['phone_number'].'</label>";
                                                echo "<input type='number' class='form-control' id='phone-number' name='phone-number'>";
                                            echo "</div>";


                                            echo "<div class='address my-4'>";
                                                echo "<label for='address' class='form-label'>'.$row['address'].'</label>";
