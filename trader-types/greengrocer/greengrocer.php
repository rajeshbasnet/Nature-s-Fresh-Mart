                    ...
                    <div class="breadcrumb-section">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-2 font-rubik">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="/website/project/trader-types/greengrocer/greengrocer.php">Greengrocer</a>
                                </li>
                    ...
                    while ($row = oci_fetch_assoc($result)) { ?>
                        <div class="individual-product">
                            ...
                            <div class="btn-container font-rubik">
                                <a href="/website/project/trader-types/greengrocer/individual-product/greengrocer-product.php?search=<?php echo $row['PRODUCT_ID'] ?>"
