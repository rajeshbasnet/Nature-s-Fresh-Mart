...
?>
    ...
    <header>
        ...
        <div class="bg-image position-absolute">
            <img src="../bakery/images/bg-img/pexels-madison-inouye-192933.jpg" class="w-100" alt="" />
        </div>
                    ...
                    <div class="breadcrumb-section">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-2 font-rubik">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="/website/project/trader-types/bakery/bakery.php">Bakery</a>
                                </li>
                    ...
                    while ($row = oci_fetch_assoc($result)) { ?>
                        <div class="individual-product">
                            ...
                            <div class="btn-container font-rubik">
                                <a href="/website/project/trader-types/bakery/individual-product/bakery-product.php?search=<?php echo $row['PRODUCT_ID'] ?>"
