...
<header>
    ...
    <div class="carousel-heading position-absolute text-center">
        ...
        <div class="btn-container text-center">
            <a href="/website/project/form/signin/signin.php" class="btn btn-first">Login</a>
    ...
    <section class="header-img my-5">
        ...
        <div class="custom-container mt-5">
            <div class="column column-first position-relative">
                ...
                <a href="/website/project/trader-types/butcher/butcher.php" class="position-absolute font-rale">Butcher</a>
            </div>

            <div class="column column-middle">
                <img src="./images/homepage/traders/fishmonger.jpg" class="column-img" alt="" />
                <a href="/website/project/trader-types/fishmonger/fishmonger.php" class="position-absolute font-rale">Fishmonger</a>
            </div>

            <div class="column column-middle">
                <img src="./images/homepage/traders/delicatessen.jpg" class="column-img" alt="" />
                <a href="/website/project/trader-types/delicatessen/delicatessen.php" class="position-absolute font-rale">Delicatessen</a>
            </div>

            <div class="column column-middle">
                <img src="./images/homepage/traders/greengrocer.jpg" class="column-img" alt="" />
                <a href="/website/project/trader-types/greengrocer/greengrocer.php" class="position-absolute font-rale">Greengrocer</a>
            </div>

            <div class="column column-last">
                <img src="./images/homepage/traders/bakery.jpg" class="column-img" alt="" />
                <a href="/website/project/trader-types/bakery/bakery.php" class="position-absolute font-rale">Bakery</a>
            </div>
        </div>
    </section>
